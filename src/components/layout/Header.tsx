  ...
  return (
    <header className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-5 py-5 md:px-8">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <Link
          href="/"
          className="inline-flex items-center gap-2 rounded-2xl bg-white px-4 py-3 text-lg font-black text-slate-950 shadow-sm transition hover:-translate-y-0.5"
        >
